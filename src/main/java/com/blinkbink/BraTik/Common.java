...
import com.blinkbink.BraTik.Pola.Nomor;
import com.blinkbink.BraTik.Pola.HurufKecil;
...
public class Common extends Application {
    ...
    public static int MIN_DIST_GESTURE = 1;
    public static int MIN_DIST_SPECIAL_SHORT_MOVE = 100;
    public static int MIN_DIST_SPECIAL_LONG_MOVE = 100;
    public static int MIN_DOT_RADIUS = 30;
    ...
    public static final int DEFAULT_PORTRAIT_KEYBOARD_HEIGHT = 70;
    public static final int DEFAULT_LANDSCAPE_KEYBOARD_HEIGHT = 95;
    public static final int DEFAULT_PORTRAIT_KEYBOARD_WIDTH = 10;
    public static final int DEFAULT_LANDSCAPE_KEYBOARD_WIDTH = 10;
    public static final boolean DEFAULT_KEYBOARD_RIGHT_POSITION = true;
    ...
    public static final boolean DEFAULT_START_DOTS_FROM_RIGHT = true;
    ...
    public static final int DEFAULT_DOTS_LAYOUT = 0;
    ...
    public static final int DEFAULT_BRAILLE_DOTS_SOUND = 1;
    public static final int DEFAULT_GET_SELECTED_DOTS_NUMBER_PERIOD = 500; //In milliseconds
    public static Locale currentLocaleLanguage = new Locale("id"); // When the user changes the keyboard types or keyboard language
    public static String TAG = "BraTik";
    ...
    public static int keyboardHeightPortrait = 50;
    public static int keyboardHeightLandscape = 50;
    ...
    public static Locale currentSystemLocaleLanguage = new Locale("id");
    public static Locale indonesiaLocale = new Locale("id");
    ...
    public static int getDefaultDotRadius(int theMode) {
        try {
            ...
            if(selectedDotsLayout == BRAILLE_CELL_DOTS_LAYOUT) {
                theWidth = (int) (theWidth * ((float) selectedKeyboardWidth / 90));
                theHeight = (int) (theHeight * ((float) selectedKeyboardHeight / 90));

                //I need the dots margin to be considered if the keyboard height is full
                if(selectedKeyboardHeight == 50){
    ...
    public static void changeKeyboardLanguage(KeyboardSurface keyboardSurface, InputConnection inputConnection) {
        try {
            ...
            if(nextLang == ENGLISH_LANGUAGE_INPUT_METHOD){
                keyboardSurface.patternSurface = new HurufKecil(context);
            }
    ...
    public static void setPatternSurfaceLanguage(KeyboardSurface keyboardSurface, InputConnection inputConnection) {
        try {
            if (isEnglishInputMethodActivated && defaultKeyboardLanguage == ENGLISH_LANGUAGE_INPUT_METHOD) {
                keyboardSurface.patternSurface = !isNumericInputText ? new HurufKecil(context) : new Nomor(context);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
