...
import com.blinkbink.BraTik.voiceime.VoiceRecognitionTrigger;
    ...
    public void onFinishInputView(boolean finishingInput) {
        try {
            ...
            if (Common.speakHiddenKeyboard && ic != null && !finishingInput) {
                ...
                if (readTextAfterCloseKeyboard && fullText.length() > 0 && (Common.currentSystemLanguage.equals("Indonesia") || (Common.currentSystemLanguage.equals("ar") && Common.defaultTextSpeech.isArabicSupported()))) {
