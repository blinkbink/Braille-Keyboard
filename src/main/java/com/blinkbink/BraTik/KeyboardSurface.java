...
import com.blinkbink.BraTik.Pola.HurufKapital;
import com.blinkbink.BraTik.Pola.Nomor;
import com.blinkbink.BraTik.Pola.SpesialKarakter;
import com.blinkbink.BraTik.surfacelayout.BrailleCellLayout;
import com.blinkbink.BraTik.surfacelayout.BrailleLayout;
import com.blinkbink.BraTik.Pola.Pattern;
                    ...
                    if (patternSurface.getPatternResult() != null) {
                        ...
                        if (patternSurface.brailleIndicatorType(selectedPattern) == 0) {
                            ...
                            if (Common.currentLanguage == Common.ENGLISH_LANGUAGE_INPUT_METHOD) {
                                patternSurface = new HurufKapital(context);
                            }
                            ...
                            previousPatternSurface = patternSurface;
                            if(Common.currentLanguage == Common.ENGLISH_LANGUAGE_INPUT_METHOD) {
                                patternSurface = new Nomor(context);
                            }
                            //Speech the class title
                            patternSurface.speechClassTitle();
                            ...
                            previousPatternSurface = patternSurface;
                            if(Common.currentLanguage == Common.ENGLISH_LANGUAGE_INPUT_METHOD) {
                                patternSurface = new SpesialKarakter(context);
                            }
                            //Speech the class title
                            patternSurface.speechClassTitle();
                        } else {
